...
export default function GinzaRightBook1() {
      ...
      <main className="flex flex-col text-center items-center bg-gradient-to-br min-h-screen from-violet-300 to-indigo-300 via-blue-100">
        ...
        <div className='p-2 m-2 bg-violet-100 text-black rounded-xl'>
          <div className='flex flex-row flex-wrap justify-center items-center text-center'>
            ...
            <p className='p-2 m-2 border-b-2 border-violet-200'>{lidzbarskiginza[language].sections[1].text[0].title}</p>
            <div className='flex flex-row justify-center items-center text-center'>
              <ArrowRightCircleIcon className='h-6 w-6 m-2' />
            </div>
          </div>
            <h3 className='text-xl lg:text-2xl font-bold uppercase p-4 m-4'>{lidzbarskiginza[language].sections[1].text[0].title}</h3>
            <h3 className='text-lg lg:text-xl font-bold uppercase p-4 m-4'>{lidzbarskiginza[language].sections[1].text[0].introduction}</h3>
            { lidzbarskiginza[language].sections[1].text[0].verses.map((paragraph) => 
              <div className='flex flex-row items-center'>
                <p className='rounded-full bg-violet-300 p-2 m-2'>{lidzbarskiginza[language].sections[1].text[0].verses.indexOf(paragraph) + 1}</p>
