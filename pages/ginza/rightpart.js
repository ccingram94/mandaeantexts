...
export default function GinzaRightPart() {
    ...
    <>
      ...
      <main className="flex flex-col text-center items-center bg-gradient-to-br min-h-screen from-violet-300 to-indigo-300 via-blue-100">
        ...
        <div className='flex flex-row flex-wrap justify-center items-center text-center'>
            ...
            <p className='p-2 m-2 border-b-2 border-violet-200'>{lidzbarskiginza[language].sections[1].title}</p>
            <div className='flex flex-row justify-center items-center text-center'>
              <ArrowRightCircleIcon className='h-6 w-6 m-2' />
            </div>
          </div>
            <h3 className='text-xl lg:text-2xl font-bold uppercase p-4 m-4'>{lidzbarskiginza[language].sections[1].title}</h3>
            { lidzbarskiginza[language].sections[1].introduction.map((paragraph) => 
